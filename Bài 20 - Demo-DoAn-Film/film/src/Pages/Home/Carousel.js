              ...
              >
                <div className="modal-dialog modal-xl" role="document">
                  <div className="modal-content embed-responsive embed-responsive-16by9">
                    <iframe
                      title="carouselFrame"
                      src="https://www.youtube.com/embed/KSFS0OfIK2c"
                      frameBorder={0}
              ...
              >
                <div className="modal-dialog modal-xl" role="document">
                  <div className="modal-content embed-responsive embed-responsive-16by9">
                    <iframe
                      title="carouselFrame"
                      src="https://www.youtube.com/embed/0lA5BJuiVGU"
                      frameBorder={0}
                      className="embed-responsive-item"
                      allowFullScreen
                    />
                ...
                <div className="modal-dialog modal-xl" role="document">
                  <div className="modal-content embed-responsive embed-responsive-16by9">
                    <iframe
                      className="embed-responsive-item"
                      title="carouselFrame"
                      src="https://www.youtube.com/embed/LTxMXEWsuFE"
                      frameBorder={0}
                      allowFullScreen
                    />
                  </div>
                  ...
                  <div className="modal-dialog modal-xl" role="document">
                    <div className="modal-content  embed-responsive embed-responsive-16by9">
                      <iframe
                        className="embed-responsive-item"
                        title="carouselFrame"
                        src="https://www.youtube.com/embed/o-PmHDtO2DQ"
                        frameBorder={0}
                        allowFullScreen
                      />
                    </div>
                ...
                <div className="modal-dialog modal-xl" role="document">
                  <div className="modal-content embed-responsive embed-responsive-16by9">
                    <iframe
                      className="embed-responsive-item"
                      title="carouselFrame"
                      src="https://www.youtube.com/embed/L4D4-ZTWUWI"
                      frameBorder={0}
                      allowFullScreen
                    />
                  </div>
